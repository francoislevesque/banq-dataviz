...
d3.csv("/data/countries.csv", function(error, regionData) {
...
d3.select("#foursix").on("click", function () {
    updateChords( "/data/foursix.json" );
...
d3.select("#sevennine").on("click", function() {
    updateChords( "/data/sevennine.json" );
   // disableButton(this);
});

d3.select("#tentwelve").on("click", function() {
    updateChords( "/data/tentwelve.json" );
    //disableButton(this);
});

d3.select("#thirteenfiveteen").on("click", function() {
    updateChords( "/data/thirteenfiveteen.json" );
    //disableButton(this);
});
/*
